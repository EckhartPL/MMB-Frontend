      ...
      <ul className="navbar-nav">
        <li className="logo">
          <Link to="/" className="nav-link">
            <span className="link-text logo-text">MMB</span>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
        ...
        <li className="nav-item">
          <Link to="/article/1" className="nav-link">
            <svg className="fa-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        ...
        <li className="nav-item">
          <Link to="/projects" className="nav-link">
            <svg className="fa-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              {/* <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
        ...
        <li className="nav-item">
          <Link to={endpoints.contact} className="nav-link">
            <svg className="fa-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
              {/* <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
        ...
        <li className="nav-item">
          <Link to={endpoints.login} className="nav-link">
            <svg className="fa-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              {/* <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
              <path d="M470.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 256 265.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160zm-352 160l160-160c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L210.7 256 73.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0z" />
            </svg>
            <span className="link-text">Login/Sign up</span>
          </Link>
        </li>
      </ul>
    </nav>
